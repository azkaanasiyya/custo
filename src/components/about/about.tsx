...
export default function About() {
  return (
    <SlideFadeIn
      items={[
        { selector: "[data-animate='title']", direction: "y", from: 60 },
        { selector: "[data-animate='description']", direction: "y", from: 60 },
        { selector: ".list > div", direction: "y", from: 40 },
      ]}
      staggerDelay={0.15}
    >
      <div className="about-section py-12 px-6 md:py-20 md:px-12 lg:px-[4rem] lg:py-[6.5rem] flex flex-col justify-center items-center">
        <div className="container w-full mx-auto max-w-[67rem] flex flex-col gap-16 items-start lg:items-center lg:justify-center">
          <div className="header flex flex-col gap-4 lg:flex-row justify-between lg:items-end">
            <div className="typography w-80 lg:w-[27.1875rem]" data-animate="title">
              <h3 className="text-[28px] md:text-[36px] leading-[140%] font-semibold lg:text-[40px]">
                Guided by Purpose and Principles
              </h3>
            </div>
            <p className="text-large md:text-xlarge text-grayscale-600 max-w-[32.875rem]" data-animate="description">
          ...
          <div className="list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 rounded-[1.25rem] border shadow-sm border-grayscale-200">
            <div className="flex flex-col p-5 md:p-[2.5rem] gap-[1.5rem] border-r">
            ...
            <div className="flex flex-col p-5 md:p-[2.5rem] gap-[1.5rem] border-t md:border-r">
            ...
            <div className="flex flex-col border-t p-5 md:p-[2.5rem] gap-[1.5rem] md:col-span-2 lg:col-span-1 lg:border-t-0 lg:border-l">
