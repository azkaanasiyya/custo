...
export default function AboutHero() {
  return (
    <div className="hero-section pt-[9.5rem] pb-[6rem] px-[3.5rem] flex flex-col bg-grayscale-50 items-center">
        <div className="container w-full mx-auto max-w-[67rem] flex flex-col gap-[4rem] items-center justify-center">
            ...
            <div className="content grid grid-cols-2 lg:grid-cols-3 gap-[1.25rem] w-full">
            ...
            <div className="clients flex flex-col gap-[2rem] pt-[0.5rem] justify-center items-center w-full overflow-hidden">
              <p className="text-xlarge text-grayscale-600 text-center">Trusted by companies around the world</p>
