...
export default function AboutQuote() {
    return (
        <div className="quote-section bg-[url('/background/bg-about.svg')] bg-no-repeat bg-cover h-[608px] py-[104px] px-16 flex flex-col justify-center items-center">
            <div className="container max-w-[1072px] flex flex-row justify-between items-center">
                ...
                <div className="content flex flex-col gap-8 max-w-[526px]">
                    ...
                    <div className="profile flex flex-col gap-0.5">
