...
export default function AboutQuote() {
    return (
        <div className="quote-section bg-[url('/background/bg-about.svg')] bg-no-repeat bg-center max-h-[38rem] py-[6.5rem] px-[1rem] flex flex-col justify-center items-center">
