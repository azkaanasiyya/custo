...
export default function AboutQuote() {
    return (
        <div className="quote-section bg-[url('/background/bg-about.svg')] bg-cover lg:bg-no-repeat lg:bg-center lg:max-h-[38rem] py-20 px-12 lg:py-[6.5rem] lg:px-4 flex flex-col justify-center items-center">
                ...
                <div className="content flex flex-col gap-[2rem] lg:max-w-[32.875rem]">
                    <div className="header flex flex-col gap-[1rem]">
                        <div className="typography font-semibold text-grayscale-950">
                            <h3 className="text-[36px] leading-[140%] font-semibold lg:text-[40px]">Together, We Grow Better</h3>
                        </div>
