...
export default function AboutTeam() {
  return (
    <div className="team-section py-20 px-12 lg:py-[6.5rem] lg:px-[1rem] flex flex-col justify-center items-center">
      <div className="container max-w-[67rem] w-full mx-auto flex flex-col lg:justify-center items-center gap-[4rem]">
        ...
        <div className="team grid grid-cols-2 lg:grid-cols-4 w-full gap-[1.25rem]">
          {teamMembers.map((member, index) => (
            <div key={index} className="flex flex-col w-full gap-[1.5rem]">
              <Image src={member.image} className="w-full h-auto" alt={member.name} width={253} height={280} />
