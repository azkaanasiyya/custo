...
export default function HeaderBlogDetail({ slug }: HeaderBlogDetailProps) {
  ...
  return (
    <div className="flex w-full lg:px-16 items-center justify-center">
      <div>
        <SlideFadeIn
          delay={0}
          className="flex flex-col gap-[2rem] w-full max-w-mobile md:max-w-tablet lg:max-w-desktop pt-[120px] md:pt-[9rem]"
        >
          <Link href="/blog">
